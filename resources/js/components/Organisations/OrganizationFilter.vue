<script setup>
import { useOrgFilterComposable } from "../../composables/organization/orgFilterComposable";
    ...
    <div class="col-12">
        <div class="bg-label-secondary d-flex justify-content-between mb-3 p-2 rounded-3">
            <div class="d-flex">
                ...
                <input type="text" v-if="filter.org_location === 'local-area' || filter.org_location === 'location'"
                       class="form-control form-control-sm rounded-pill ms-2"
                       placeholder="Enter local area i.e. suburb, post code, council area etc."
                       v-model="filter.org_local_area"/>

                <div class="dropdown" v-if="filter.org_location === 'states'">
                    ...
                    <ul class="dropdown-menu">
                        <li v-for="state in orgStore.states" :key="state">
                            <label class="dropdown-item">
                                <input type="checkbox" :value="state.state" v-model="filter.org_states"
                ...
                <select class="form-select form-select-sm rounded-pill ms-2"
                        v-model="filter.org_suburbs" v-if="filter.org_location === 'suburbs'"
                ...
                <input type="text" aria-labelledby="location-label" v-if="filter.org_location === 'radius'"
                       ...
                       class="form-control form-control-sm rounded-pill ms-2" v-model="filter.org_radius_location"/>

                <select class="form-select form-select-sm rounded-pill ms-2" name="radius"
                        v-model="filter.org_radius" v-if="filter.org_location === 'radius'"
