...
<template>
  <div class="col-12">
    <div
      class="bg-label-secondary d-flex justify-content-between mb-3 p-2 rounded-3"
    >
      <div class="d-flex">
        <select
          class="form-select form-select-sm rounded-pill ms-2"
          v-model="filter.category"
          @change="handleFilterNfp"
        >
