...
return new class extends Migration {
    ...
    {
        Schema::create('org_pref_values', function (Blueprint $table) {
            $table->id();
            $table->foreignId('org_preference_id')->constrained('org_preferences')->cascadeOnDelete();
            ...
            $table->string('type', 40)->comment('offer, looking');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('org_pref_values');
    }
};
